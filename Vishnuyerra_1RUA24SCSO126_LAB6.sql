...
-- OUTPUT
/*3	2	22:14:53	CREATE DATABASE HospitalDB	1 row(s) affected	0.047 sec*/

USE HospitalDB;
-- OUTPUT
/*3		22:15:27	USE HospitalDB	0 row(s) affected	0.000 sec */
...
-- OUTPUT
/*
3	4	22:15:53	CREATE TABLE Patients (
     patient_id INT PRIMARY KEY AUTO_INCREMENT,
     patient_name VARCHAR(50),
     age INT,
     gender VARCHAR(10)
...
-- OUTPUT
/*
3	5	22:16:21	CREATE TABLE Visits (
     visit_id INT PRIMARY KEY AUTO_INCREMENT,
     patient_id INT,
     visit_date DATE,
     doctor_id INT,
...
('Tejas', 35, 'Male');
-- OUTPUT
/* 3	7	22:20:20	INSERT INTO Patients (patient_name, age, gender)
 VALUES
 ('Sundar', 22, 'Male'),
 ('Shreya', 28, 'Female'),
 ('Mahesh', 35, 'Male'),
 ('Nea', 32, 'Female'),
 ('Tejas', 35, 'Male')	5 row(s) affected
 Records: 5  Duplicates: 0  Warnings: 0	0.015 sec */

INSERT INTO Visits (patient_id, visit_date, doctor_id, diagnosis, treatment_cost)
VALUES
(1, '2025-01-21', 101, 'Fever and Cold', 600.00),
(2, '2025-01-13', 102, 'Migraine', 1050.00),
(3, '2025-01-23', 103, 'Diabetes Checkup', 500.00),
(1, '2025-02-18', 104, 'Allergy', 300.00),
(4, '2025-02-02', 101, 'Sprained Ankle', 1650.00),
(5, '2025-03-25', 105, 'High Blood Pressure', 1800.00),
(2, '2025-03-15', 104, 'Flu', 550.00),
(3, '2025-03-12', 102, 'Back Pain', 1000.00),
(4, '2025-04-11', 105, 'Skin Infection', 1000.00),
(1, '2025-04-25', 101, 'Routine Checkup', 500.00);
-- OUTPUT
/*
3	8	22:23:33	INSERT INTO Visits (patient_id, visit_date, doctor_id, diagnosis, treatment_cost)
 VALUES
 (1, '2025-01-21', 101, 'Fever and Cold', 600.00),
 (2, '2025-01-13', 102, 'Migraine', 1050.00),
 (3, '2025-01-23', 103, 'Diabetes Checkup', 500.00),
 ...
 (3, '2025-03-12', 102, 'Back Pain', 1000.00),
 (4, '2025-04-11', 105, 'Skin Infection', 1000.00),
 (1, '2025-04-25', 101, 'Routine Checkup', 500.00)	10 row(s) affected
 Records: 10  Duplicates: 0  Warnings: 0	0.047 sec*/
...
1	1	2025-01-21	101	Fever and Cold	600.00
2	2	2025-01-13	102	Migraine	1050.00
3	3	2025-01-23	103	Diabetes Checkup	500.00
4	1	2025-02-18	104	Allergy	300.00
5	4	2025-02-02	101	Sprained Ankle	1650.00
6	5	2025-03-25	105	High Blood Pressure	1800.00
7	2	2025-03-15	104	Flu	550.00
8	3	2025-03-12	102	Back Pain	1000.00
9	4	2025-04-11	105	Skin Infection	1000.00
10	1	2025-04-25	101	Routine Checkup	500.00 */
...
Fever and Cold	600.000000
Migraine	1050.000000
Diabetes Checkup	500.000000
Allergy	300.000000
Sprained Ankle	1650.000000
High Blood Pressure	1800.000000
Flu	550.000000
Back Pain	1000.000000
Skin Infection	1000.000000
Routine Checkup	500.000000 */
...
-- OUTPUT
/* 3	14	22:27:38	CREATE INDEX idx_patient_id ON Visits(patient_id)	0 row(s) affected
