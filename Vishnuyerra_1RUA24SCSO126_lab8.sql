...
-- OUTPUT
/* 3	2	22:43:45	CREATE DATABASE SchoolDB	1 row(s) affected	0.047 sec */

USE SchoolDB;
-- OUTPUT
/* 3	3	22:44:11	USE SchoolDB	0 row(s) affected	0.000 sec */
...
-- OUTPUT
/*
3	4	22:46:47	CREATE TABLE Students (
     StudentID INT PRIMARY KEY AUTO_INCREMENT,
     StudentName VARCHAR(50),
     Age INT,
     Marks DECIMAL(5,2)
...
-- OUTPUT
/*
3	5	22:47:04	CREATE TABLE StudentLogs (
     LogID INT PRIMARY KEY AUTO_INCREMENT,
     ActionType VARCHAR(50),
     ActionDate DATETIME,
     Description VARCHAR(200)
...
-- OUTPUT
/*
3	8	22:48:01	CREATE TRIGGER before_student_insert
 BEFORE INSERT ON Students
 FOR EACH ROW
 BEGIN
     IF NEW.Marks > 100 THEN
...
-- OUTPUT
/*  0	9	22:48:19	INSERT INTO Students (StudentName, Age, Marks) VALUES ('Diya', 19, 110)	Error Code: 1644. Marks cannot be greater than 100.	0.047 sec */
...
-- OUTPUT
/* 3	10	22:48:55	CREATE TRIGGER after_student_insert
 AFTER INSERT ON Students
 FOR EACH ROW
 BEGIN
     INSERT INTO StudentLogs (ActionType, ActionDate, Description)
 ...
 END	0 row(s) affected	0.046 sec
 */
...
1	INSERT	2025-11-10 22:49:17	New student added: Riya, Marks: 89.00
*/
...
-- OUTPUT
/*
3	13	23:01:12	CREATE TRIGGER after_student_update
 AFTER UPDATE ON Students
 FOR EACH ROW
 BEGIN
     -- Check if marks were actually changed
     ...
     END IF;
 END	0 row(s) affected	0.063 sec */

UPDATE Students
SET Marks = 92
WHERE StudentID = 1;
-- Output
/* 3	14	23:01:34	UPDATE Students
 SET Marks = 92
 WHERE StudentID = 1	1 row(s) affected
 Rows matched: 1  Changed: 1  Warnings: 0	0.047 sec */
...
LogID, ActionType, ActionDate, Description
1	INSERT	2025-11-10 22:49:17	New student added: Riya, Marks: 89.00
2	UPDATE	2025-11-10 23:01:34	Marks updated for Riya: Old Marks = 89.00, New Marks = 92.00 */
...
-- OUTPUT
/*
3	16	23:02:35	CREATE TRIGGER after_student_delete
 AFTER DELETE ON Students
 FOR EACH ROW
 BEGIN
     INSERT INTO StudentLogs (ActionType, ActionDate, Description)
...
-- Output
/* 3	17	23:03:07	DELETE FROM Students WHERE StudentID = 1	1 row(s) affected	0.000 sec */
...
1	INSERT	2025-11-10 22:49:17	New student added: Riya, Marks: 89.00
2	UPDATE	2025-11-10 23:01:34	Marks updated for Riya: Old Marks = 89.00, New Marks = 92.00
3	DELETE	2025-11-10 23:03:07	Student deleted: Riya, Marks: 92.00
*/
